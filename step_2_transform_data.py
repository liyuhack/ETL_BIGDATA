...
#filter null values and nan(numeric) values with median
...
# 6. Encode Categories with freindly name for analysis
df = df.withColumn(
    "category_encoded", 
...
for column, count in null_counts.items():
    print(f"Number of nulls before cleaning in {column} column: {count}")
